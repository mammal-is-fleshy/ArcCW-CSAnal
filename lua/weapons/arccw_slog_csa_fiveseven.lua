...
SWEP.Trivia_Desc = "As expensive as it is gorgeous, the NXS is a fine handgun. Chambered in the 5.7x28mm cartridge, while not effective against flesh targets,  superior capability to penetrate body armor. The hefty magazine size paired with the cartridge makes this the best weapon in its class to use against armored opponents."
...
SWEP.ShootSound = "weapons/arccw_slog/csa/fn57/fire.ogg"
